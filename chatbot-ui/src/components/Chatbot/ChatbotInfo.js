...
const ChatbotInfo = ({ showInfo, actions }) => (
  <Modal
    ...
    content={[
      ...
      '',
      [
        'The chatbot profile picture is made by ',
        ...
        ', licensed by ', <a href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0" target="_blank" rel="noopener noreferrer" key="cc">CC 3.0 BY</a>
      ]
    ]}
    show={showInfo}
